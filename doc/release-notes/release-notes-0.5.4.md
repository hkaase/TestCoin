Testcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/Testcoin/files/Testcoin/Testcoin-0.5.4/
...
http://gitorious.org/Testcoin/Testcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Testcoin-Qt notifications under Growl 1.3.
Increase required age of Testcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxTestcoin properly when installing Testcoin-Qt over it. (Windows)

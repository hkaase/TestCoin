Download URL: https://sourceforge.net/projects/Testcoin/files/Testcoin/Testcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 tst fee schedule (users still pay 0.01 tst per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #Testcoin00 - #Testcoin99

...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += "  -rpcport=<port>        " + strprintf(_("Listen for JSON-RPC connections on <port> (default: %u or testnet: %u)"), 7887, 8778) + "\n";
...
{
    return FormatParagraph(strprintf(_("Copyright (C) 2009-%i The Testcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
